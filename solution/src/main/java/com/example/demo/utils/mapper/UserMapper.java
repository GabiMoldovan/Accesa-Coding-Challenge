...
public final class UserMapper {
    public static UserResponse entityToDto(User user) {
        return new UserResponse(
                ...
                user.getBaskets() != null ? BasketMapper.entityListToDto(user.getBaskets()) : null,
                user.getPriceAlerts() != null ? PriceAlertMapper.entityListToDto(user.getPriceAlerts()) : null
        );
    }
